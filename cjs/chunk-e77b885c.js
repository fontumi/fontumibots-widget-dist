...
const NAMESPACE = 'fontumibots-widget';
...
const patchBrowser = async () => {
    // @ts-ignore
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('chunk-e77b885c.js', document.baseURI).href));
    if (importMeta !== '') {
